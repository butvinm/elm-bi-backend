...
#   timestamp: 2025-01-03T23:40:38+00:00
...
class UpdateDashboardPostRequest(BaseModel):
    dashboard_id: int
    title: str


class TestDataSourceConnectionPostResponse(BaseModel):
    error: Optional[str] = None


class SetDataSourcePostRequest(BaseModel):
    dashboard_id: int
...
class GetDataSourceTablesPostResponseItem(BaseModel):
    name: str = Field(
        ...,
...
class GetDataSourceTablesPostResponse(
    RootModel[List[GetDataSourceTablesPostResponseItem]]
):
    root: List[GetDataSourceTablesPostResponseItem]
...
class Dashboard(BaseModel):
    ...
    title: Optional[str] = Field(
        None, description='User-defined title of the dashboard.'
    )
